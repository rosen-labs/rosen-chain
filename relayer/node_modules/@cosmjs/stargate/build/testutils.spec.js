...
exports.defaultSendFee = fee_1.calculateFee(80000, exports.defaultGasPrice);
exports.simapp = {
    ...
    govMinDeposit: proto_signing_1.coins(10000000, "ustake"),
};
exports.slowSimapp = {
...
class ModifyingSecp256k1HdWallet extends amino_1.Secp256k1HdWallet {
    ...
    async signAmino(signerAddress, signDoc) {
        const modifiedSignDoc = Object.assign(Object.assign({}, signDoc), { fee: {
                amount: proto_signing_1.coins(3000, "ucosm"),
                gas: "333333",
...
class ModifyingDirectSecp256k1HdWallet extends proto_signing_1.DirectSecp256k1HdWallet {
    ...
    async signDirect(address, signDoc) {
        ...
        const modifiedFeeAmount = proto_signing_1.coins(3000, "ucosm");
