...
describe("SigningStargateClient", () => {
    describe("constructor", () => {
        it("can be constructed with custom registry", async () => {
            ...
            const options = Object.assign(Object.assign({}, testutils_spec_1.defaultSigningClientOptions), { registry: registry });
    ...
    describe("sendIbcTokens", () => {
        it("works with direct signing", async () => {
            ...
            // both timeouts set
            {
                const result = await client.sendIbcTokens(testutils_spec_1.faucet.address0, testutils_spec_1.faucet.address1, proto_signing_1.coin(1234, "ucosm"), "fooPort", "fooChannel", { revisionHeight: long_1.default.fromNumber(123), revisionNumber: long_1.default.fromNumber(456) }, Math.floor(Date.now() / 1000) + 60, fee, memo);
            ...
            // no height timeout
            {
                const result = await client.sendIbcTokens(testutils_spec_1.faucet.address0, testutils_spec_1.faucet.address1, proto_signing_1.coin(1234, "ucosm"), "fooPort", "fooChannel", undefined, Math.floor(Date.now() / 1000) + 60, fee, memo);
                // CheckTx must pass but the execution must fail in DeliverTx due to invalid channel/port
                expect(stargateclient_1.isBroadcastTxFailure(result)).toEqual(true);
            }
        });
