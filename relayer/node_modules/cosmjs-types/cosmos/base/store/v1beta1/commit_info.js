...
const baseCommitInfo = { version: long_1.default.ZERO };
exports.CommitInfo = {
    ...
    decode(input, length) {
        ...
        const message = Object.assign({}, baseCommitInfo);
        message.storeInfos = [];
...
exports.StoreInfo = {
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseStoreInfo);
        while (reader.pos < end) {
            const tag = reader.uint32();
            switch (tag >>> 3) {
                case 1:
...
const baseCommitID = { version: long_1.default.ZERO };
exports.CommitID = {
    encode(message, writer = minimal_1.default.Writer.create()) {
        if (!message.version.isZero()) {
            writer.uint32(8).int64(message.version);
    ...
    decode(input, length) {
        const reader = input instanceof minimal_1.default.Reader ? input : new minimal_1.default.Reader(input);
        let end = length === undefined ? reader.len : reader.pos + length;
        const message = Object.assign({}, baseCommitID);
