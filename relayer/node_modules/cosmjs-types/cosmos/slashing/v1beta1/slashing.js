...
exports.ValidatorSigningInfo = {
    ...
    fromJSON(object) {
        ...
        if (object.startHeight !== undefined && object.startHeight !== null) {
            message.startHeight = long_1.default.fromString(object.startHeight);
        }
        else {
            message.startHeight = long_1.default.ZERO;
        }
        if (object.indexOffset !== undefined && object.indexOffset !== null) {
            message.indexOffset = long_1.default.fromString(object.indexOffset);
        }
        else {
            message.indexOffset = long_1.default.ZERO;
        }
        ...
        if (object.missedBlocksCounter !== undefined && object.missedBlocksCounter !== null) {
            message.missedBlocksCounter = long_1.default.fromString(object.missedBlocksCounter);
        }
        else {
            message.missedBlocksCounter = long_1.default.ZERO;
        }
        return message;
    },
    toJSON(message) {
...
exports.Params = {
    ...
    fromJSON(object) {
        ...
        if (object.signedBlocksWindow !== undefined && object.signedBlocksWindow !== null) {
            message.signedBlocksWindow = long_1.default.fromString(object.signedBlocksWindow);
        }
        else {
            message.signedBlocksWindow = long_1.default.ZERO;
        }
